...
describe("MultiSigWallet", function () {
    ...
    beforeEach(async function () {
        ...
        multisigWallet = await MultisigWallet.deploy(["0x70997970C51812dc3A010C7d01b50e0d17dc79C8", "0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266",], 2);
    });

    it("TxHash", async function () {
        txHash = await multisigWallet.encodeTransactionData('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', '1000000000000000000', '0x', '0', '1');
    ...
    it("contact signature", async () => {
        ...
        const success_1 = await multisigWallet.execTransaction('0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266', '1000000000000000000', '0x', signContact);
